...
# This is the user that the nginx web server runs as, and nginx will need 
# to be able to read and write WordPress files in order to serve the website and perform automatic updates.
